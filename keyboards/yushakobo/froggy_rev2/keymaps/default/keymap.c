...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_OPT] = LAYOUT( \
        ...
        KC_DOT,  KC_V,    KC_C,    KC_L,    KC_Z,     KC_Q,    _______, \
    ...
    */
    [_FUNC] = LAYOUT(
        ...
        RGB2,  RGB_VAD, KC_F4,   KC_F5,   KC_F6,   KC_F12,  _______, \
    ...
    */
    [_SYM] = LAYOUT( \
        ...
        _______, KC_DLR,  KC_UP,   KC_AT,    KC_EXLM, KC_PIPE, _______, \
   ...
   */
    [_NUM] = LAYOUT( \
        ...
        KC_PDOT,  KC_SLSH, KC_P4,      KC_P5,   KC_P6,   KC_PLUS,        _______, \
