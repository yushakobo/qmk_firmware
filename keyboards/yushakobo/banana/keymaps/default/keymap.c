...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_4x13(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   MO(3),
        KC_LCTL, KC_LALT, KC_DEL,  MO(1),       KC_SPC,        A(KC_GRV),       MO(2),   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_ortho_4x13(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV,
        KC_TAB,  KC_TRNS, KC_TRNS, KC_TRNS, KC_SCLN, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT, KC_ENT,
